...
1. Download the installer (MSI for Windows, DMG for macOS, DEB for Linux)
2. Run the installer
...
- **macOS:** `Shelter for Mind-1.0.1.dmg`
- **Linux:** `shelter-for-mind_1.0.1_amd64.deb`

---

## System Requirements

- **Operating System:** Windows 10+, macOS 11+, or Linux (Ubuntu 20.04+, Debian 10+)
- **Java:** Bundled (no separate installation required)
...
For a complete list of features, see the [v1.0.0 Release Notes](RELEASE_NOTES.md) or [CHANGELOG.md](CHANGELOG.md).
